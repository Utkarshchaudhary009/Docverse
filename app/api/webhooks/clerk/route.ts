...
export async function POST(req: Request) {
    ...
    constbody = JSON.stringify(payload);
    ...
    if (!id) {
        return new Response("Error occurred -- no id", {
            status: 400,
        });
    }

    // Handle the event
    // We use fetchMutation to call the internal Convex mutation from this Server Action/Route
